...
// By clicking the [More] button, it should reveal the content of a hidden div
// and changes the text of the button to [Less]. When the same link is clicked again
