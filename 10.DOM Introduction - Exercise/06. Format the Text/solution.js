function solve() {
  ...
  const textArr = input.value.split('.').filter(s => s !== '');
...
// Create a functionality that gets a text from textarea, formats the given text - you need to find
// out how many sentences there are in the text, simply split the whole text by '.'
