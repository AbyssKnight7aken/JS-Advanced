function subtract() {
    ...
    const sum = Number(firstNumberElement.value) - Number(secondNumberElement.value);
...
// convert them to numbers, subtract the first number from the second one and then append the result
// to the <div> with id="result".
